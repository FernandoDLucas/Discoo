...
class HomeViewController : UIViewController{
    ...
    let collectionView : UICollectionView = {
        ...
        cv.register(AlbumCards.self, forCellWithReuseIdentifier: AlbumCards.reuseIdentifier)
    ...
    @objc func add(){
        let navControll = UINavigationController(rootViewController: CreateAlbumViewController())
...
extension HomeViewController : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: AlbumCards.reuseIdentifier, for: indexPath) as? AlbumCards
        if let album = viewModel.albumForRow(at: indexPath.row){
